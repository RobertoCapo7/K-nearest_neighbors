...
/**
 * Classe controller delle seguenti interfacce: caricaDatabase
 **/
public class ControllerDatabase implements Initializable {
    ...
    /** Variabile di istanza di tipo campo di testo che conterrà il nome della tabella dato in input dall'utente **/
    @FXML
    ...
    /** Metodo invocato quando viene cliccato il pulsante calcola dell'interfaccia caricaDatabase
     *
     * @param event
     */
    @FXML
    private void loadDatabase(ActionEvent event) {
        try {
            ...
            String percorso = nomeTabella.getText();
            ...
            if (percorso.equals("")) {
                ...
                alert.setHeaderText("Non è stato inserito il nome della tabella!");
                alert.showAndWait();
