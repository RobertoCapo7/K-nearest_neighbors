...
/**
 * Classe responsabile per l'input da tastiera.
 */
public class Keyboard {
	// ************* Error Handling Section **************************

	/** Variabile statica di tipo boolean per il print degli errori*/
	private static boolean printErrors = true;

	/** Variabile statica di tipo int che conta gli errori*/
	 ...
	 * @param count contatore di tipo intero
	 */
	...
	/** Variabile statica di tipo String che conterrà il token corrente */
	private static String current_token = null;

	/** Variabile statica di tipo StringTokenizer usata per dividere una stringa in varie sottostringhe, delimitate da un carattere speciale */
	private static StringTokenizer reader;

	/** Variabile statica di tipo BufferedReader usata per leggere l'input da tastiera */
	...
	public static int readInt() {
		...
		try {
			...
			error("Non è stato inserito un numero intero.");
	...
	public static double readDouble() {
		...
		try {
			...
			error("Non è stato inserito un valore continuo!");
			value = Double.NaN;
		}
		return value;
	}
